...
```cmd
setx DATABASE_URL "postgresql://cdss_user:Password123!@localhost:5432/medical_cdss"
```

**Windows PowerShell:**
```powershell
[Environment]::SetEnvironmentVariable("DATABASE_URL", "postgresql://cdss_user:Password123!@localhost:5432/medical_cdss", "User")
```
...
```
DATABASE_URL=postgresql://cdss_user:Password123!@localhost:5432/medical_cdss
...
| Connection String | `postgresql://cdss_user:Password123!@localhost:5432/medical_cdss` |
